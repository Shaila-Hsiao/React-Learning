    ...
    (function (Items) {
        ...
        var Item = (function (_super) {
            ...
            Item.prototype.resize = function (height, width, depth) {
                ...
                console.log(this.getWidth(), this.getHeight(), this.getDepth());
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultWallTexture = {
            url: "./static/blueprint/rooms/textures/wallmap.png",
            stretch: true,
            scale: 0
        };
        /**
...
(function (BP3D) {
    ...
    (function (Model) {
        ...
        var defaultRoomTexture = {
            url: "./static/blueprint/rooms/textures/hardwood.png",
            scale: 400
        };
        /**
...
(function (BP3D) {
    ...
    (function (Three) {
        Three.Edge = function (scene, edge, controls) {
            ...
            var texture = null;
            var lightMap = THREE.ImageUtils.loadTexture("./static/blueprint/rooms/textures/walllightmap.png");
